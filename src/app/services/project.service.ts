  ...
  private projects = [
    {
      ...
      screenshots: [
        'assets/Notely-screenshot1.png',
        'assets/Notely-screenshot2.png'
      ],
      screencastUrl: 'https://www.youtube.com/embed/your-video-id',
    ...
    {
      title: 'Cactus Diary',
      description: '"Cactus Diary" ist deine persönliche digitale Oase zum Festhalten von Gedanken und Erlebnissen. Erstelle ganz einfach neue Einträge, füge deine Emotionen und Bilder hinzu und organisiere deine Erinnerungen in einem übersichtlichen Dashboard. Dank der vollständigen Benutzerverwaltung mit Anmelde- und Abmeldefunktion sowie Passwort- und Profiloptionen sind deine Einträge stets sicher und privat. Ein anpassbarer Dark-Mode sorgt zudem für ein angenehmes Leseerlebnis zu jeder Tageszeit.',
      ...
      screenshots: [
        'assets/CactusDiary-screenshot1.png',
        'assets/CactusDiary-screenshot2.png'
      ],
      screencastUrl: 'https://www.youtube.com/embed/your-video-id',
    ...
    },
     {
      ...
      screenshots: [
        'assets/Neptun-screenshot1.png',
        'assets/Neptun-screenshot2.png'
      ],
      screencastUrl: 'https://www.youtube.com/embed/your-video-id',
      technologies: ['Java', 'Spring Boot', 'MySQL'],
      liveUrl: null, 
